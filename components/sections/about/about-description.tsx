...
export default function AboutDescription() {
  return (
    <div className='flex h-full w-auto flex-col justify-start gap-1'>
    ...
    >
      <div className='flex h-full flex-row gap-4'>
        <p className='text-pretty leading-relaxed tracking-wide'>
          Seekor kera, terkurung, terpenjara dalam gua <br /> Di gunung tinggi,
          sunyi tempat hukuman para dewa <br /> Bertindak sesuka hati loncat ke
          sana ke sini <br /> Hiraukan semua masalah di muka bumi ini <br />{' '}
          Dengan sehelai bulu dan rambut dari tubuhnya <br /> Dia merubah,
          menerpa, menerjang segala apa yang ada <br />
        </p>
        <p className='text-pretty leading-relaxed tracking-wide'>
